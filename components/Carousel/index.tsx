...
const dummyData = [
  {
    ...
    title: "God of War",
    description:
      "Venture into the brutal Norse realms and fight to fulfill a deeply personal quest.",
    date: "OUT NOW",
    price: "59.99",
  },
  {
    ...
    description:
      "A battle royale for fighting game fans powered by parkour with an array of ranged and melee weapons to choose from.",
    date: "OUT NOW",
    price: "19.99",
  },
  {
    ...
    description:
      "A story-driven, action adventure combining exploration with fast-paced combat.",
    date: "OUT NOW",
    price: "27.99",
  },
  {
...
const Carousel = () => {
  ...
  return (
    <div className="grid grid-cols-4 gap-8">
      <div className="col-span-3 rounded-xl h-[594px] relative overflow-hidden">
        <AnimatePresence>
          <motion.img
            exit={{ opacity: 0, x: -50 }}
            animate={controls}
...
const Thumbnail = ({
  ...
  return (
    <li
      onClick={onClick}
      className={`h-[96.5px] rounded-2xl flex flex-row items-center space-x-3 cursor-pointer hover:bg-appGray mb-1 relative ${
        activeSlide === index ? "bg-black" : ""
      }`}
    >
      <div
        className={`bg-violet-600 ${
          activeSlide === index ? "animate-thumbnail" : ""
      ...
      />
      <p className="text-white text-[16px] z-10">{title}</p>
    </li>
  );
};
